  ...
  namespace AMapUI {
    namespace PathNavigator {
      interface Options<D = any> {
         ...
         * 巡航器的样式
         */
        pathNavigatorStyle?: PathSimplifier.RenderOptions<D>["pathNavigatorStyle"];
        /**
         * 动画触发的间隔，单位：毫秒
    ...
    class PathNavigator<D = any> {
       ...
       */
      public constructor (options?: PathNavigator.Options<D>);

      /** 巡航器编号 */
      public id: number;
      /** 巡航器状态 */
      public type: PathNavigatorEventType;
      /** 巡航光标状态 */
       ...
       *
       * @public
       * @param {PathNavigatorEventType} eventName 事件名称
       * @param {Function} callback 回调函数
       */
      public on (
        eventName: PathNavigatorEventType,
        callback: (
          obj: { type: PathNavigatorEventType; target: PathNavigator<D> },
          info: {
            tail: number;
            dataItem: { type: string; pathIndex: number; pointIndex: number; pathData: D[] };
            nextDataItem: { type: string; pathIndex: number; pointIndex: number; pathData: D[] };
          },
        ) => void,
      ): void;
      /**
       ...
       */
      public off (eventName: PathNavigatorEventType, callback: AnyFunction): void;
    }
  }
}
