...
declare global {
  namespace Loca {
     ...
     * @extends {Layer<G, ZMarkerLayer.StyleOptions>} 抽象类 - 图层
     */
    class ZMarkerLayer<G extends GeoJSON = GeoJSON> extends Layer<G, ZMarkerLayer.StyleOptions> {
      /**
       * 构造函数
       *
       * @constructor
