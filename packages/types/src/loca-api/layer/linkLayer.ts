...
declare global {
  namespace Loca {
    namespace LinkLayer {
       ...
       */
        lineColors?: Layer.StyleRender<COLOR[], GeoJSON.LineString, E & PlainObject<"link" | "distance">>;
        /**
       * 弧顶最高高度
       ...
       * @unitSymbol m
       */
        height?: Layer.StyleRender<number, GeoJSON.LineString, E & PlainObject<"distance">>;
        /**
       * 平滑步数
       * - 弧线的分隔段数，越大平滑度越好
       *
