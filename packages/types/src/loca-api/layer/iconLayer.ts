  ...
  namespace Loca {
    namespace IconLayer {
      ...
      interface StyleOptions {
         ...
         * @default 0
         */
        rotation?: number | AnyFunction;
        /**
         * 透明度，支持通过回调函数为每个点设置不同的透明度
         *
         * @default 1
         */
        opacity?: number | AnyFunction;
        /**
         * 图标偏移的位置大小，右上方为正方向
         * - 单位取决于属性 `unit` 的值
         *
     ...
     * @extends {Layer<G, IconLayer.StyleOptions>} 抽象类 - 图层
     */
    class IconLayer<G extends GeoJSON = GeoJSON> extends Layer<G, IconLayer.StyleOptions> {
      /**
       * 构造函数
       *
       * @constructor
