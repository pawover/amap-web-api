...
declare global {
  namespace AMap {
    namespace Marker {
      ...
      interface Events extends EventCommon<Marker>, EventDrag<Marker> {
        /**
     ...
     * @implements {Accessor.Clickable} 是否支持鼠标单击事件
     ...
     * @implements {Accessor.Options<Marker.Options>} 属性配置
    ...
    class Marker
      ...
      implements
        ...
        Accessor.ExtData,
        Accessor.Offset,
        Accessor.Options<Marker.Options>,
        Accessor.Position,
        Accessor.ZIndex,
        MoveAnimation {
      /**
       ...
       * @deprecated AMap Web API 2.x 中已废弃
       */
      public markOnAMAP (params: PlainObject<"position", LngLatLike>): void;
      /** 获取 DOM 容器 */
      ...
      /** 获取标记文本配置选项 */
      public getLabel (): string | Marker.LabelOptions;
      /** 设置标记文本配置选项 */
      public setLabel (options: string | Marker.LabelOptions): void;
