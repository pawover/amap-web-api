...
declare global {
  namespace AMap {
     ...
     */
    class PlaceSearch extends Event<ServiceEventType> {
      /**
       * 构造函数
       *
       * @constructor
      ...
      public search (keyword: string, callback: (status: "no_data", result: PlainObject) => void): void;
      /**
       * 通过关键字和范围查询
       *
       * @public
      ...
      public searchInBounds (
        keyword: string,
        bounds: BoundsLike,
        callback?: (status: "no_data", result: PlainObject) => void,
      ): void;
      /**
      ...
      public getDetails (id: string, callback: (status: "no_data", result: PlainObject) => void): void;
      /**
       * 设置查询的 POI 类型
       *
       * @public
