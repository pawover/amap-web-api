...
declare global {
  namespace AMap {
    ...
    type ServiceEventType
      = "choose" | "select" | "complete" | "error" | "selectChanged" | "listElementClick" | "markerClick";
    ...
    /** 事件名称列表 */
    type EventType
      = MapEventType | OverlayEventType | ContextMenuEventType | ServiceEventType | EditorEventType | ToolEventType;
