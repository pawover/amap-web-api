...
export function Marker (props: MarkerProps & { ref?: Ref<MarkerProps & { instance: AMap.Marker | undefined }> }) {
  const { marker, wrapper } = useMarker(props);
  useImperativeHandle(props.ref, () => ({ ...props, instance: marker }), [props, marker]);
