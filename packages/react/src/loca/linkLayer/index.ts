...
export function LinkLayer<G extends GeoJSON = GeoJSON, E = any> (props: LinkLayerProps<G, E> & { ref?: Ref<LinkLayerProps<G, E> & { instance: Loca.LinkLayer<G, E> | undefined }> }) {
  const { linkLayer } = useLinkLayer<G, E>(props);
  useImperativeHandle(props.ref, () => ({ ...props, instance: linkLayer }), [props, linkLayer]);
