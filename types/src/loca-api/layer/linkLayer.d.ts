declare namespace Loca {
  namespace LinkLayer {
    ...
    interface StyleOptions<ExtraData extends {} = {}> extends LineLayer.StyleOptions<ExtraData> {
       ...
       */
      lineColors?: Layer.StyleRender<COLOR[], GeoJSON.LineString, ExtraData & Recordable<'link' | 'distance'>>;
      /**
       * 弧顶最高高度
       ...
       * @unitSymbol m
       */
      height?: Layer.StyleRender<number, GeoJSON.LineString, ExtraData & Recordable<'distance'>>;
      /**
       * 平滑步数
       * - 弧线的分隔段数，越大平滑度越好
       *
       * @default 100
       */
      smoothSteps?: Layer.StyleRender<number[], GeoJSON.LineString, ExtraData>;
    }
  }
