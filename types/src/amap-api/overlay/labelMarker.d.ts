declare namespace AMap {
   ...
   * @implements {GetSet.Options<LabelMarker.Options>} 属性配置
  ...
  class LabelMarker
    ...
    implements
      ...
      GetSet.ExtData,
      GetSet.Opacity,
      GetSet.Options<LabelMarker.Options>,
      GetSet.Position,
      GetSet.Zooms,
      GetSet.ZIndex,
      MoveAnimation
  {
    ...
    public setDraggable: undefined;

    public getExtData: () => unknown;
    public setExtData: undefined;

    public getOpacity: () => number;
    public setOpacity: (opacity: number) => void;

    public getOptions: () => LabelMarker.Options;
    public setOptions: undefined;
