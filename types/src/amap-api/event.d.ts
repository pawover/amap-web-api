declare namespace AMap {
   ...
   * - `target` 触发事件的目标对象
   */
  interface MapsEvent<T extends EventList, I> {
    /** 事件类型 */
    type: T;
    /** 触发事件的目标对象 */
    target?: T extends 'draw' ? never : I;
    /** 发生事件时光标所在处的经纬度坐标 */
    lnglat?: ControlPoint | LngLat;
    /** 发生事件时光标所在处的像素坐标 */
    pixel?: Pixel;
    /** 原始事件 */
   ...
   */
  class Event<T extends EventList> {
    /**
     * 添加事件绑定
     *
     * @public
     ...
     * @param {T} type 事件类型
     */
    public static clearListeners<I, T extends EventList>(instance: I, type: T): void;
    /**
     * 触发非 DOM 事件
     ...
     */
    public static trigger<I, T extends EventList>(instance: I, type: T, data: unknown): void;
  ...
  class event {
     ...
     * @returns {(EventListener & { type: 1 })}
     */
    public addListenerOnce<I extends EventEmitter, C = I>(
      instance: I,
      type: EventList,
      callback?: (this: C, event: unknown) => void,
      context?: C,
     ...
     */
    public removeListener(listener: EventListener & { type: 0 | 1 }): void;
    /**
     * 清除事件
     *
     * @deprecated AMap Web API 2.x 中已废弃
     ...
     * @param {?unknown} [params] 额外参数
     */
    public trigger(instance: EventEmitter, type: EventList, params?: unknown): void;
  }
}
