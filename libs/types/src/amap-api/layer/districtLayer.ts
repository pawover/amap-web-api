declare namespace AMap {
   ...
   *
   * @class DistrictLayer
   * @extends {Layer<DistrictLayer.Options, OverlayEventType>} 抽象类 - 图层
   */
  class DistrictLayer extends Layer<DistrictLayer.Options, OverlayEventType> {
    /**
     * 构造函数
     *
     * @constructor
    ...
    /** 获取行政区编码 */
    public getDistricts(): Record<string, number> | undefined;
    /** 设置行政区编码，同 `setAdcode` */
